          ...
          >
            ...
            <InteractiveTilt>
              <motion.img
                ...
                className="relative z-10 w-[80%] md:w-[75%] max-w-lg drop-shadow-[0_0_60px_rgba(251,191,36,0.15)]"
                animate={{ y: [0, -12, 0] }}
              ...
              <HudOverlay 
                ...
                side="right"
                stats={[
                  { label: "Power Stages", value: "24+4 Phase" },
                  { label: "Stability", value: "Ultra-Low Ripple" },
                  { label: "Peak Load", value: "1000A Delivery" }
                ]}
              />
            </InteractiveTilt>
          </motion.div>
