          ...
          >
            ...
            <InteractiveTilt>
              <motion.img
                ...
                className="relative z-10 w-[80%] md:w-[75%] max-w-lg drop-shadow-[0_0_60px_rgba(59,130,246,0.15)]"
                animate={{ y: [0, -12, 0] }}
              ...
              <HudOverlay 
                ...
                side="left"
                stats={[
                  { label: "Substrate", value: "14-Layer PCB" },
                  { label: "Traces", value: "High-Speed Low-Loss" },
                  { label: "Precision", value: "Sub-Micron Etching" }
                ]}
              />
            </InteractiveTilt>
          </motion.div>
